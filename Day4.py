...
a=[50,60,70,80]
b=[50,60,70,80]
print(id(a))  # the list is mutable (in the list we can add or delete the numbers so the storage addressis different  )
print(id(b))
print(a is b)
...
>>>>>>> 83d6dc58e1a94a683e8f53682e505d2d2107a2ef
